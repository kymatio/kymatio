...
def scattering1D_filter_factory():
  ...
  ###############################################################################
  # The parameter `T` specifies the temporal support of low-pass filter, 
  # controlling the amount of imposed time-shift invariance and maximum 
  # subsampling
  ...
  # `scattering_filter_factory` method, which takes the logarithm of `N` and
  ...
  # `phi_f[0]` corresponds to the lowpass filter at resolution `N`, while 
  # `phi_f[1]` corresponds to the filter at resolution `N/2`, and so on.
  #
...
def scattering1D_filter_factory_T():
  ###############################################################################
  #
  # Constructs scattering filters, adjusting the T parameter which controls the
  # amount of imposed time-shift invariance and maximum subsampling
