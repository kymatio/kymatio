...
unit tests, the speed as well as the documentation. You might be willing to install auxiliary libraries via the
``requirements_optional.txt``.

For development purposes, you might be willing to install the package via::
...
Thank you for reporting us your numbers!
