...
It is built on top of standard library in python, such as NumPy, PyTorch or TensorFlow. Our framework allows to use
high-level frontend to directly plug the Scattering Network to your application. It also incorporates backend which
allows low-level tuning of the code. For instance, the PyTorch API includes a fast CUDA backend via cupy and skcuda.
