...
from .scattering2d.frontend.sklearn_frontend import (
    ScatteringTransformer2D as Scattering2D,
)
from .scattering3d.frontend.sklearn_frontend import (
    HarmonicScatteringTransformer3D as HarmonicScattering3D,
)

Scattering1D.__module__ = "kymatio.sklearn"
Scattering1D.__name__ = "Scattering1D"

TimeFrequencyScattering.__module__ = "kymatio.sklearn"
