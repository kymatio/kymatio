...
from .scattering1d.frontend.numpy_frontend import TimeFrequencyScatteringNumPy as TimeFrequencyScattering
...
TimeFrequencyScattering.__module__ = 'kymatio.numpy'
...
__all__ = ['Scattering1D', 'TimeFrequencyScattering', 'Scattering2D', 'HarmonicScattering3D']
